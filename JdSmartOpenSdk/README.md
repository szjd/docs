...
是否支持登陆，登陆提示信息，是否支持全部场景功能（详情见[ getHostInfo接口函数](JdSmart_Open_Sdk#JdSmartHostInfo_getHostInfo.28.29 "wikilink")）
...
<thead>
<tr class="header">
<th><p>开关类型设备(灯，开关，插座，电视，机顶盒)</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tr class="even">
<td><p>当前移动位置<br />
例如填写0表示关闭，100表示打开，只有0和100两个进度值</p></td>
</tr>
</tbody>
</table>
...
<thead>
<tr class="header">
<th><p>有开关和一个进度属性的设备(窗帘，开窗器等)</p></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tr class="even">
<td><p>当前移动位置<br />
例如填写10, 表示移动10%, 0表示关闭，100表示打开</p></td>
</tr>
</tbody>
</table>
